	    ...
	    _createClass(CrumbOptionsList, [{
	        ...
	        value: function render() {
	            ...
	            if (listUI) return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'closeBtn fa fa-times-circle', onClick: this.props.close },
	                    ' '
	                ),
	                _react2.default.createElement(
	                    'div',
	    ...
	    _createClass(C_ListItem, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.props.getChildren(this.props.treeNode) ? _react2.default.createElement("i", { className: "fa fa-chevron-circle-right", style: iStyle }) : null
	            );
	        }
	    }]);
